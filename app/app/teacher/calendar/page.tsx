...
export default async function TeacherCalendarPage({
  ...
  const [{ data: schoolDays }, { data: handoffs }, { data: photos }] = await Promise.all([
  ...
  return (
    <div>
      <header>
        ...
        <p className="mt-2 text-sm text-[#69746f]">Consulte dias publicados, passagens de turno e atividades registradas.</p>
      </header>
